# متتبع الحياة اليومية v2.3.1 🏆

تطبيق Flutter شامل لتتبع الحياة اليومية مع إدارة المهام، المشاريع، والإحصائيات.

[![Version](https://img.shields.io/badge/version-2.3.1-blue.svg)](https://github.com/youssefmahmoud/daily-life-tracker)
...
### ✨ الميزات الجديدة:
- 🎯 **ملف شخصي محسن** - تعديل الاسم والصورة الشخصية
- ⚙️ **إعدادات متقدمة** - الوضع الليلي، تغيير اللغة، التنبيهات
- 📊 **عرض معلومات التطبيق** - الإصدار ورقم البناء
- 👨‍💻 **معلومات المطور** - بيانات مطور التطبيق
- 🎨 **تصميم محسّن** - واجهة أكثر احترافية وجمالاً
- 📱 **أداء محسّن** - سرعة أكبر واستجابة أفضل

### 🐛 الإصلاحات:
- ✅ إصلاح مشاكل التنقل في الملف الشخصي
- ✅ حل تعارض الألوان والمتغيرات
- ✅ إصلاح أخطاء deprecated APIs
