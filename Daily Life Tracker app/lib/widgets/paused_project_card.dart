// ignore_for_file: unnecessary_non_null_assertion, dead_code, unnecessary_null_comparison
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: DashedBorder(
          ...
          dashWidth: 5,
          dashSpace: 3,
          top: BorderSide(color: AppColors.gray400.withValues(alpha: 0.5)),
          right: BorderSide(color: AppColors.gray400.withValues(alpha: 0.5)),
          bottom: BorderSide(color: AppColors.gray400.withValues(alpha: 0.5)),
          left: BorderSide(color: AppColors.gray400.withValues(alpha: 0.5)),
        ),
      ),
      child: Padding(
