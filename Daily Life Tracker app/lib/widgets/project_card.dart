...
class ProjectCard extends StatelessWidget {
  ...
  Color _getTechColor(String tech, {bool isDark = false}) {
    switch (tech.toLowerCase()) {
      case 'flutter':
        return isDark ? AppColors.primaryColor.withValues(alpha: 0.9) : AppColors.primaryColor;
      case 'firebase':
        return isDark ? const Color(0xFFFFB74D) : const Color(0xFFFFA726);
      case 'healthtech':
        return isDark ? AppColors.successColor.withValues(alpha: 0.9) : AppColors.successColor;
      case 'web':
        return isDark ? AppColors.warningColor.withValues(alpha: 0.9) : AppColors.warningColor;
      case 'html':
